...
describe('Handlebars.js interface', function () {
  ...
  it('should declare .hbs as a supported extension', done => {
    factory.metadata.extensions.indexOf('.hbs').should.not.equal(-1)
  ...
  it('should load filters, helpers and partials', done => {
    ...
    instance.initialise().then(() => {
      ...
      Object.keys(helpers.additionalTemplates).forEach(name => {
        const type = typeof core.partials[name]
